...
print(f"{"program".title()}: {glossary["program"]}\n")
print(f"{"algorithm".title()}: {glossary["algorithm"]}\n")
print(f"{"debugging".title()}: {glossary["debugging"]}\n")
print(f"{"api".title()}: {glossary["api"]}\n")
print(f"{"syntax".title()}: {glossary["syntax"]}\n")